      ...
      {showStandupModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4 text-black">Daily Stand-up Update</h3>
            <form onSubmit={submitStandup}>
              <div className="mb-4">
                <label className="block text-sm font-medium mb-2 text-black">What did you do yesterday?</label>
                <textarea
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-2 text-black">What will you do today?</label>
                <textarea
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium mb-2 text-black">Any blockers?</label>
                <textarea
